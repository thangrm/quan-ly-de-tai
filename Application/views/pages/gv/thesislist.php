                ...
                <tbody>
                    <tr>
                        ...
                        <td class="thesis-action">
                            ...
                            <!-- Button trigger modal -->
                            <button type="button" class="btn btn-warning thesis-action-btn" data-bs-toggle="modal" data-bs-target="#update-thesis">Sửa</button>
                            <!-- Modal -->
                                        ...
                                        <div class="modal-body">
                                            <form>
                                                <fieldset >
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="thesis-author" class="form-label required">Sinh viên thực hiện</label>
                                                        <input type="text" id="thesis-author" class="form-control" value="Nguyễn Mộng Mơ">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="thesis-description" class="form-label">Mô tả vắn tắt</label>
                    ...
                    <tr>
                        ...
                        <td class="thesis-action">
                            ...
                            <!-- Button trigger modal -->
                            <button type="button" class="btn btn-success thesis-action-btn" data-bs-toggle="modal" id="confirm-thesis">Duyệt</button>
                            <!-- Button trigger modal -->
                            <button type="button" class="btn btn-warning thesis-action-btn" data-bs-toggle="modal" data-bs-target="#update-thesis">Sửa</button>
                            <!-- Modal -->
                            <div class="modal fade" id="update-thesis" tabindex="-1" aria-labelledby="update-thesis-Label" aria-hidden="true">
